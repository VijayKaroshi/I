pipeline {
  ...
  stages {
    ...
    stage('RunDASTUsingZAP') {
      steps {
        bat("D:\\DevSecopstools\\ZAP\\ZAP_2.16.0_Crossplatform\\zap.bat -port 9393 -cmd -quickurl https://www.example.com -quickprogress -quickout D:\\DevSecopstools\\ZAP\\zapoutput\\Output.html")
      }
    }
